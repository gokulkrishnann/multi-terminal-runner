...
function activate(context) {
    const disposable = vscode.commands.registerCommand("multiCmdTerminal.openUI", async () => {
        const panel = vscode.window.createWebviewPanel("multiCmdTerminalUI", "Multi Cmd Terminal", vscode.ViewColumn.One, {
            enableScripts: true,
        });
